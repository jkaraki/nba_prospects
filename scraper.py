...
player_links=[]
url_template_team = "http://www.barttorvik.com/team.php?team={parsed}&year=2017"
count = 0
print(2017)
for team in my_list:
    ...
    for b in links_with_text:
        if 'playerstat.php?year=2017&p' == b[:26]:
            player_links.append(b)


import csv
with open('player_urls_2017', 'w') as myfile:
...
df.to_csv('player_data_2017.csv')
